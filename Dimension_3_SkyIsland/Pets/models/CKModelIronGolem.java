package mymod.Dimension_3_SkyIsland.Pets.models;
...
public class CKModelIronGolem extends ModelBase
{
    ...
    public CKModelIronGolem()
    {
        this(0.0F);
    }

    public CKModelIronGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public CKModelIronGolem(float p_i46362_1_, float p_i46362_2_)
    {
        short short1 = 128;
        short short2 = 128;
